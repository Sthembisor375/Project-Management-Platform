...
function SideBar({ collapsed }) {
  ...
  const navItems = [
    { key: "dashboard", label: "Dashboard", path: "/home/dashboard", icon: (
      <svg
    ...
    { key: "workload", label: "Workload", path: "/home/workload", icon: (
      <svg
        width="28"
        height="28"
        viewBox="0 0 24 24"
    ...
    { key: "tickets", label: "Tickets", path: "/home/tickets", icon: (
      <svg
        width="28"
        height="28"
        viewBox="0 0 24 24"
    ...
    { key: "clients", label: "Clients", path: "/home/clients", icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="20"
        height="20"
    ...
    { key: "settings", label: "Settings", path: "/home/settings", icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="20"
        height="20"
